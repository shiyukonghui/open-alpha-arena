  ...
  return (
    <div className="space-y-4">
      <div className="flex justify-between items-center">
        <h2 className="text-2xl font-bold">{t('comprehensive.title')}</h2>
                  ...
                  {aiDecisions.length === 0 ? (
                    ...
                    <div className="space-y-2">
                      <div className="grid grid-cols-6 gap-2 text-sm font-medium text-muted-foreground border-b pb-2">
                        ...
                        <div className="col-span-1">{t('common.time')}</div>
                        <div className="col-span-1">{t('portfolio.ai_decisions')}</div>
                        <div className="col-span-1">{t('common.operation')}</div>
                        <div className="col-span-1">{t('common.portion')}</div>
                        <div className="col-span-1">{t('common.reason')}</div>
                      </div>
                      {aiDecisions.map((decision) => (
                        <div key={decision.id} className="grid grid-cols-6 gap-2 text-sm py-2 border-b">
                          <div className="col-span-1 font-medium">{decision.symbol || '-'}</div>
                          <div className="col-span-1 text-xs">{new Date(decision.decision_time).toLocaleTimeString()}</div>
                          <div className="col-span-1">
                            <span className={`px-2 py-1 rounded text-xs ${
                          ...
                          <div className="col-span-1 text-xs">
                            {decision.prev_portion.toFixed(1)}% → {decision.target_portion.toFixed(1)}%
                          </div>
                          <div className="col-span-1 text-xs">
